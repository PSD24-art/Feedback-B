...
exports.generateFacultyReport = async (req, res) => {
  try {
    ...
    worksheet.columns = [
      ...
      { header: "Subject Knowledge(Avg)", key: "p1Avg", width: 12 },
      { header: "Teaching Effectiveness(Avg)", key: "p2Avg", width: 12 },
      { header: "Communication & Engagement(Avg)", key: "p3Avg", width: 12 },
      { header: "Evaluation & Feedback(Avg)", key: "p4Avg", width: 12 },
      { header: "Professional Conduct(Avg)", key: "p5Avg", width: 12 },
